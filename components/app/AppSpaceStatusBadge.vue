...
const label = computed(() => {
  ...
  if (props.kind === 'radio') return 'Radio'
...
const kindClass = computed(() => {
  ...
  if (props.kind === 'radio') {
    return 'bg-[var(--p-primary-color)]/12 text-[var(--p-primary-color)]'
  }
  if (props.kind === 'idle') {
