/**
 * Per-Author Posts JSON Feed — GET /u/:username/posts/feed.json
 */
import { buildPostJsonFeed } from '../../../../utils/post-feed'
...
export default defineEventHandler(async (event) => {
  ...
  const json = buildPostJsonFeed({
    feedUrl: `${site}/u/${u}/posts/feed.json`,
    homePageUrl: `${site}/u/${u}`,
