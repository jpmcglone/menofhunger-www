...
export const VOICE = {
  ...
  lodgeDescription:
    'Men of Hunger is a community for honest dialogue, accountability, and no noise.',
  ...
  onboarding: {
    ...
    accountSubtitle: 'Pick a username. The rest can wait.',
    interestsHeading: 'What are you building?',
    interestsSubtitle: 'Pick at least one arena.',
    doorHeading: 'One last thing.',
    doorSubtitle: "Then you're in.",
    heardAboutLabel: 'How did you hear about us?',
