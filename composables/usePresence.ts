...
export function usePresence() {
  ...
  return {
    ...
    setNotificationNavUnread: badges.setNotificationNavUnread,
    ...
    addBoardCallback: domains.board.add,
    removeBoardCallback: domains.board.remove,
    subscribeBoard: subscriptions.subscribeBoard,
    unsubscribeBoard: subscriptions.unsubscribeBoard,
