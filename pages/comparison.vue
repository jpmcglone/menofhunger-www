...
const sections: ComparisonSection[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      { x: 'DM access is broad once enabled.', moh: 'Tiered messaging: verified can start DMs with mutuals (people who follow you back); premium can DM any verified member.' },
      { x: 'No tier-gated posting formats by trust level.', moh: 'Verified posts images and GIFs; premium unlocks video.' },
      { x: 'No first-class poll gate by trust + commitment.', moh: 'Verified polls with result notifications in the core feed/notification flow.' },
      { x: 'Basic saves.', moh: 'Bookmark collections/folders for organized saving (verified required).' },
