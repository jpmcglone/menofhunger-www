...
<script setup>
  ...
  async function getSentryData() {
    // Purely frontend test (no Nuxt server API route).
    // This should show up in Sentry as a transaction/span + an exception event.
...
<template>
  <div>
    <main>
      ...
      <p class="description">
        Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://jp-mcglone.sentry.io/issues/?project=4510859430789120">Issues Page</a>.
