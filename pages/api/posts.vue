...
const fields: ApiDocsField[] = [
  ...
  { name: 'boostCount, commentCount, repostCount, bookmarkCount, viewerCount, totalViewCount', type: 'number', note: 'viewerCount is unique people; totalViewCount is accepted impressions.' },
